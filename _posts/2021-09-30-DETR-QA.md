...
![Panoptic_Flow]({{ site.baseurl }}/images/DETR-QA/0_DETR_Panoptic.png "Panoptic Flow")
...
![Encoder]({{ site.baseurl }}/images/DETR-QA/7_Encoded_Image.png "Encoder")
...
![Box_Image_Attention]({{ site.baseurl }}/images/DETR-QA/8_Box_Image_attn.png "Box Image Attention")
...
![ResNet_FeatureMaps]({{ site.baseurl }}/images/DETR-QA/12_Res_Middle.png "ResNet FeatureMaps")
...
![Maps_2_Masks]({{ site.baseurl }}/images/DETR-QA/11_Res_Up.png "Maps to Masks")

### RESULT

This than is passed though Pixel-wise Argmax and concatenated to get the final Panoptic Segmentation Mask.

![Panoptic_Result]({{ site.baseurl }}/images/DETR-QA/10_Panoptic.png "Panoptic Results")
